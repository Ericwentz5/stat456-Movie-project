...
cults <- movies_df_working %>%
  filter(rev_budget_ratio < 3, vote_average > 7.8, release_date < "2010-01-01" )
```

### Viz

```{r fig.alt="A scatterplot titled 'Indentifying Cult Classics' with both dots and labels visualizing the average rating given to movies by users of TMDB.com on the Y-axis and the profitability (measured as the ratio of box office return to budget) of those movies on the X-axis.", fig.width=10, fig.height=6}
